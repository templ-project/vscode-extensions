...
export const sonarLint: Extension = {
  ...
  why_required: "Advanced code analysis for detecting bugs, security vulnerabilities, and code smells across multiple languages"
};
...
export const codeRunnerVSCodium: Extension = {
  ...
  why_required: "Quick execution of code snippets for testing and prototyping across multiple languages (Open VSX compatible)"
};
