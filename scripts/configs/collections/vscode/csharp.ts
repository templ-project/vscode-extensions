...
### 5. Test Explorer Issues
- **Problem**: Tests not showing in Test Explorer
- **Solution**:
  - Ensure test project follows naming convention (*Tests.csproj)
  - Build test project: \`dotnet build\`
  - Refresh Test Explorer view
