...
export function activate(context: vscode.ExtensionContext) {
  ...
  // Register commands
  const applySettingsCommand = vscode.commands.registerCommand('templ-project.csharp-vscodium.applySettings', () => {
    applySettings();
    vscode.window.showInformationMessage('Templ Project Csharp Extension Pack settings applied!');
  });

  const resetSettingsCommand = vscode.commands.registerCommand('templ-project.csharp-vscodium.resetSettings', () => {
    resetSettings();
