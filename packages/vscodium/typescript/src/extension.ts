...
export function activate(context: vscode.ExtensionContext) {
    console.log('[templ-project-1753303368010] Typescript Extension Pack extension is now active!');
    ...
    const applySettingsCommand = vscode.commands.registerCommand('templ-project.typescript-vscodium.applySettings', () => {
        applySettings();
        vscode.window.showInformationMessage('[templ-project-1753303368010] Typescript Extension Pack settings applied!');
    });

    const resetSettingsCommand = vscode.commands.registerCommand('templ-project.typescript-vscodium.resetSettings', () => {
        resetSettings();
        vscode.window.showInformationMessage('[templ-project-1753303368010] Typescript Extension Pack settings reset!');
    });
...
export function deactivate() {
    console.log('[templ-project-1753303368010] Typescript Extension Pack extension is now deactivated!');
}
