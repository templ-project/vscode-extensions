...
export function activate(context: vscode.ExtensionContext) {
    console.log('[templ-project-1753222061225] Python Extension Pack extension is now active!');
    ...
    const applySettingsCommand = vscode.commands.registerCommand('templ-project.python-vscode.applySettings', () => {
        applySettings();
        vscode.window.showInformationMessage('[templ-project-1753222061225] Python Extension Pack settings applied!');
    });

    const resetSettingsCommand = vscode.commands.registerCommand('templ-project.python-vscode.resetSettings', () => {
        resetSettings();
        vscode.window.showInformationMessage('[templ-project-1753222061225] Python Extension Pack settings reset!');
    });
...
export function deactivate() {
    console.log('[templ-project-1753222061225] Python Extension Pack extension is now deactivated!');
}
