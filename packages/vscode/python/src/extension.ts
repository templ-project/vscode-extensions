...
function applySettings() {
  ...
  config.update('python.formatting.blackArgs', ['--line-length=88'], vscode.ConfigurationTarget.Global);
  config.update('python.sortImports.args', ['--profile=black'], vscode.ConfigurationTarget.Global);
  ...
  config.update('editor.rulers', [88], vscode.ConfigurationTarget.Global);
  ...
  config.update('python.testing.pytestArgs', ['.'], vscode.ConfigurationTarget.Global);
