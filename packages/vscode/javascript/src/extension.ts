...
export function activate(context: vscode.ExtensionContext) {
    console.log('[templ-project-1753222228322] Javascript Extension Pack extension is now active!');
    ...
    const applySettingsCommand = vscode.commands.registerCommand('templ-project.javascript-vscode.applySettings', () => {
        applySettings();
        vscode.window.showInformationMessage('[templ-project-1753222228322] Javascript Extension Pack settings applied!');
    });

    const resetSettingsCommand = vscode.commands.registerCommand('templ-project.javascript-vscode.resetSettings', () => {
        resetSettings();
        vscode.window.showInformationMessage('[templ-project-1753222228322] Javascript Extension Pack settings reset!');
    });
...
export function deactivate() {
    console.log('[templ-project-1753222228322] Javascript Extension Pack extension is now deactivated!');
}
